...
const passwordRequirements = [
  { id: 'length', label: 'Ít nhất 8 ký tự', check: (p: string) => p.length >= 8 },
            ...
            <AnimatePresence mode="wait">
              {step === 1 && (
                ...
                >
                  ...
                  <p className="text-gray-500 mb-8">Bắt đầu hành trình khám phá nghề nghiệp</p>
              ...
              {step === 2 && (
                ...
                >
                  ...
                  <p className="text-gray-500 mb-8">Bảo vệ tài khoản của bạn</p>
